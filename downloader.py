...
def query(query):
  ...
  def get_query_for_gene():
    q = \
        '''SELECT ?gene ?geneLabel ?association ?associationLabel ?protein ?proteinLabel ?chromosome ?chromosomeLabel ?substitution ?substitutionLabel ?strand ?strandLabel WHERE {
