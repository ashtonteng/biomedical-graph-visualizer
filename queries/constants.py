...
CONCEPT_ID_DICT = dict()
CONCEPT_ID_DICT.update(CORE_CONCEPT_ID_DICT)
CONCEPT_ID_DICT.update(PERIPHERAL_CONCEPT_ID_DICT)
...
EDGES_DICT = {
	...
	(PROTEIN, PROTEIN_SUPERFAMILY): (PART_OF, TAXON),
