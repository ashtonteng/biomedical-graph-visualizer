...
PHARMACEUTICAL_PRODUCT_ID = "Q28885102"
...
EDGES_DICT = {
	...
	(PROTEIN, DRUG): (INFLUENCED_BY, TAXON),

	(MOLECULAR_FUNCTION, GO): (HAS_GO, NO_TAXON),
	(MOLECULAR_FUNCTION, BIOLOGICAL_PROCESS): (PART_OF, NO_TAXON),

	(DRUG, PROTEIN): (PHYSICALLY_INTERACTS_WITH, WILDCARD),
	(DRUG, DRUG): (SIGNIFICANT_DRUG_INTERACTION, WILDCARD),
